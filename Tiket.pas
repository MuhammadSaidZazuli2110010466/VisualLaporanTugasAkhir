...
if (zqry1.Locate('tgl_tiket',edt1.Text,[])) and (zqry1.Locate('keterangan',edt2.Text,[])) then
begin
...
//simpan
zqry1.SQL.Clear;
zqry1.SQL.Add('insert into tabel_tiket values (null,"'+edt1.Text+'","'+edt2.Text+'","'+edt3.Text+'")');
zqry1.ExecSQL;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update tabel_tiket set tgl_tiket= "'+edt1.Text+'",keterangan="'+edt2.Text+'",nomer_kursi="'+edt3.Text+'" where id_tiket="'+id+'"');
zqry1. ExecSQL;
